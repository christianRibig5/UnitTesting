...
//        }
    ...
    public static void main(String[]arg){
        ArrayMethodsTest arrayMethodsTest= new ArrayMethodsTest();

        arrayMethodsTest.arrays_equals();
        System.out.println();
        arrayMethodsTest.arrays_fill();
        System.out.println();
        arrayMethodsTest.arrays_copy_of();
        System.out.println();
        arrayMethodsTest.arrays_of_range();
        System.out.println();
        arrayMethodsTest.arrays_sort();
        System.out.println();
        arrayMethodsTest.arrays_sort_in_reverese_order();
        System.out.println();
        arrayMethodsTest.arrays_selective_sort();
        System.out.println();
